  ...
  >
      ...
      <el-table-column  label="种类" width="80">
          ...
          <template slot-scope="scope">
             ...
             <el-table-column  label="使用程度" width="80">
    ...
    >
      ...
      >
        ...
        <el-form-item prop="price" label="  售价">
          <!-- v-if="addForm.type == 1" -->
          <el-input  v-model="addForm.price" placeholder="请输入价格" disabled></el-input>
          <!-- <el-input
            v-if="addForm.type == 2"
            :disabled="true"
            v-model="chagePrice"
        ...
        <el-form-item prop="cid" label=" 种类">
         ...
         <el-form-item prop="did" label=" 使用程度">
          <el-select
            v-model="addForm.did"
            placeholder="请选择分类"
            style="width:187px"
...
<el-form-item  v-if="addForm.type==2" label="急需" prop="urgent">
    ...
    >
      ...
      >
        ...
        <el-form-item prop="price" label="  售价"  >
          <el-input  v-model="showList.price" placeholder="请输入价格" disabled ></el-input>
...
this.addForm.price="";
    ...
    async getList() {
      ...
      const { data: res } = await this.$http.post("/index/getMySell1Comm",this.queryForm);
